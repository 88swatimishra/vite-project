  ...
  return (
    <div>
      <div className=' flex  justify-center px-24 pb-10'>
        ...
        <div className="relative">
            <div className="w-64 h-64 rounded-lg overflow-hidden shadow-md">
              <img src=" home2.JPG " alt="Description" className="w-full h-auto" />
      ...
      <div className=' flex   justify-center px-24 pb-10'>
        ...
        <div className="relative">
            <div className="w-64 h-64 rounded-lg overflow-hidden shadow-md">
              <img src=" home6.JPG" alt="Description" className="w-full h-auto" />
          ...
          <div className="relative">
            <div className="w-64 h-64 rounded-lg overflow-hidden shadow-md">
              <img src=" home7.JPG" alt="Description" className="w-full h-auto" />
      ...
      <div className=' flex justify-center   px-24 pb-10'>
        <div className=' flex items-center justify-center  space-x-28 pt-8 '>
          <div className="relative">
            <div className="w-64 h-64 rounded-lg overflow-hidden shadow-md">
              <img src=" home8.JPG" alt="Description" className="w-full h-auto" />
